...
class Product_gsf extends Component {
render() {
    return (
      <React.Fragment>
        <NavbarProduct />
        <Switch>
          <Route exact path="/products/gsf" component={ProductList} />
          <Route path="/products/gsf/details" component={Details} />
          <Route path="/products/gsf/cart" exact component={Cart} />
